...
function receivedAuthentication(event) {
  ...
  responses.sendTextMessage(senderID, "Authentication successful");
}
...
function receivedMessage(event) {
  ...
  if (messageText) {
    ...
    switch (messageText) {
      ...
      case 'gif':
        responses.sendGifMessage(senderID);
        break;

      case 'audio':
        responses.sendAudioMessage(senderID);
        break;

      case 'video':
        responses.sendVideoMessage(senderID);
        break;

      case 'file':
        responses.sendFileMessage(senderID);
        break;

      case 'button':
        responses.sendButtonMessage(senderID);
        break;

      case 'generic':
        responses.sendGenericMessage(senderID);
        break;
    ...
    responses.sendTextMessage(senderID, "Message with attachment received");
  }
}
...
function receivedPostback(event) {
  ...
  responses.sendTextMessage(senderID, "Postback called");
}
